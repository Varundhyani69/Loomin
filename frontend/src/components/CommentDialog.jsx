    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl p-0 flex flex-col bg-[#1e1e1e] text-white rounded-xl shadow-2xl z-50">
        <div className="flex h-[80vh]">
          <div className="w-1/2">
            <img className="w-full h-full object-cover rounded-l-xl" src={selectedPost?.image || ""} alt="post_img" />
          </div>
          ...
          <div className="w-1/2 flex flex-col">
              ...
              {isPostAuthor() && (
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-6 bg-[#2a2a2a] text-white border border-gray-700 rounded-md p-2 hidden group-hover:block z-50 text-sm">
                    <Button variant="ghost" className="w-full justify-start text-white" onClick={() => { setIsEditing(true); setEditedCaption(selectedPost.caption || ""); }}>
                      <Pencil size={16} className="mr-2" /> Edit Caption
                    </Button>
                    <Button variant="ghost" className="w-full justify-start text-red-500" onClick={deletePostHandler}>
            ...
            <div className="px-4 pb-2 text-sm text-gray-300">{likesCount} likes</div>
